...
╰┈ࠢ͜─ׄ͜─ׄ͜─ׄ͜─ׄ͜─ׄ͜─ׄ͜─ׄ͜─ׄ͜┈ࠢ͜╯`
    ...
    // =================== COMANDO #aceptarcarrera ===================
      ...
      // Verificar que el usuario que acepta es el oponente (comparar números sin dominio)
      const senderNumber = m.sender.split('@')[0]
      const opponentNumber = reto.oponente.split('@')[0]
      if (senderNumber !== opponentNumber) {
        const oponenteName = global.db.data.users?.[reto.oponente]?.name || opponentNumber
